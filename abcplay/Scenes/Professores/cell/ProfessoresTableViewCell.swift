//
//  ProfessoresTableViewCell.swift
//  abcplay
//
...
import UIKit
class ProfessoresTableViewCell: UITableViewCell {
    ...
    let removeLabel: UILabel = {
        ...
        label.text = String.fontAwesomeIcon(name: .userMinus)
        label.translatesAutoresizingMaskIntoConstraints = false
        label.textColor = UIColor.Colors.abcRed
        return label
    }()
    ...
    func bind(name: String, email: String, pos: Int) {
